        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-background/80 font-inter">
          ...
          <div>
            <h3 className="font-montserrat font-bold text-lg mb-4">Product</h3>
            <ul className="space-y-2">
              {footerLinks.product.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="font-inter text-background/80 hover:text-primary transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            <h3 className="font-montserrat font-bold text-lg mb-4">Company</h3>
            <ul className="space-y-2">
